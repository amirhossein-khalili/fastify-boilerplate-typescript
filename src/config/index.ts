...
export default function loadConfig(): void {
  ...
  // Define the schema using fluent-json-schema
  ...
  // Use the created schema with envSchema
  envSchema({
    data: result.parsed,
    schema: schema.valueOf(), // Convert fluent-json-schema object to plain JSON schema
  })
}
